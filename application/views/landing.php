...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div id="logo">
        <h1><a href="index.html"><span>s</span>Toree</a></h1>
        <!-- Uncomment below if you prefer to use an image logo -->
        <!-- <a href="index.html"><img src="<?= base_url() ?>assets/assets/img/logo.png" alt="" title="" /></a>-->
      </div>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-in">
      <h1>Welcome to sToree</h1>
      <h2>Elegant Bootstrap Template for Startups, Apps &amp; more...</h2>
      <img src="<?= base_url() ?>assets/assets/img/hero-img.png" alt="Hero Imgs" data-aos="zoom-out" data-aos-delay="100">
      <a href="<?= site_url('auth/login')?>" class="btn-get-started scrollto">Login</a>
      <div class="btns">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="feature-block">
              ...
              <img src="<?= base_url() ?>assets/assets/img/svg/cloud.svg" alt="img">
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="feature-block">
              ...
              <img src="<?= base_url() ?>assets/assets/img/svg/planet.svg" alt="img">
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="feature-block">
              ...
              <img src="<?= base_url() ?>assets/assets/img/svg/asteroid.svg" alt="img">
      ...
      <div class="container" data-aos="fade-up">
        <div class="row justify-content-center">
          ...
          <div class="col-md-5 col-lg-3">
            <img src="<?= base_url() ?>assets/assets/img/about-img.png" alt="About" data-aos="zoom-in" data-aos-delay="100">
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="<?= base_url() ?>assets/assets/img/svg/paint-palette.svg" alt="img">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="<?= base_url() ?>assets/assets/img/svg/vector.svg" alt="img">
              <h4>Retina Ready</h4>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="<?= base_url() ?>assets/assets/img/svg/design-tool.svg" alt="img">
              <h4>easy to use</h4>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="<?= base_url() ?>assets/assets/img/svg/cloud-computing.svg" alt="img">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="<?= base_url() ?>assets/assets/img/svg/pixel.svg" alt="img">
              <h4>Perfect Pixel</h4>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="<?= base_url() ?>assets/assets/img/svg/code.svg" alt="img">
              <h4>clean codes</h4>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="screens-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="<?= base_url() ?>assets/assets/img/screen/1.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?= base_url() ?>assets/assets/img/screen/2.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?= base_url() ?>assets/assets/img/screen/3.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?= base_url() ?>assets/assets/img/screen/4.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?= base_url() ?>assets/assets/img/screen/5.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?= base_url() ?>assets/assets/img/screen/6.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?= base_url() ?>assets/assets/img/screen/7.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?= base_url() ?>assets/assets/img/screen/8.jpg" class="img-fluid" alt=""></div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="100">
            <div class="team-block bottom">
              <img src="<?= base_url() ?>assets/assets/img/team/1.jpg" class="img-responsive" alt="img">
          ...
          <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="200">
            <div class="team-block bottom">
              <img src="<?= base_url() ?>assets/assets/img/team/2.jpg" class="img-responsive" alt="img">
              <div class="team-content">
                <ul class="list-unstyled">
                  <li><a href="#"><i class="bi bi-facebook"></i></a></li>
                  <li><a href="#"><i class="bi bi-twitter"></i></a></li>
          ...
          <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="300">
            <div class="team-block bottom">
              <img src="<?= base_url() ?>assets/assets/img/team/3.jpg" class="img-responsive" alt="img">
              <div class="team-content">
                <ul class="list-unstyled">
                  <li><a href="#"><i class="bi bi-facebook"></i></a></li>
                  <li><a href="#"><i class="bi bi-twitter"></i></a></li>
          ...
          <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="400">
            <div class="team-block bottom">
              <img src="<?= base_url() ?>assets/assets/img/team/4.jpg" class="img-responsive" alt="img">
              <div class="team-content">
                <ul class="list-unstyled">
                  <li><a href="#"><i class="bi bi-facebook"></i></a></li>
                  <li><a href="#"><i class="bi bi-twitter"></i></a></li>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-md-6 col-lg-4">
            <div class="block-blog text-left">
              <a href="#"><img src="<?= base_url() ?>assets/assets/img/blog/blog-image-1.jpg" alt="img"></a>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="block-blog text-left">
              <a href="#"><img src="<?= base_url() ?>assets/assets/img/blog/blog-image-2.jpg" class="img-responsive" alt="img"></a>
              <div class="content-blog">
                <h4><a href="#">whats isthe difference between good and bat typography</a></h4>
                <span>05, juin 2017</span>
                <a class="float-end readmore" href="#">read more</a>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="block-blog text-left">
              <a href="#"><img src="<?= base_url() ?>assets/assets/img/blog/blog-image-3.jpg" class="img-responsive" alt="img"></a>
              <div class="content-blog">
                <h4><a href="#">whats isthe difference between good and bat typography</a></h4>
                <span>05, juin 2017</span>
                <a class="float-end readmore" href="#">read more</a>
